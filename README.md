...
> ✅ Built from scratch to showcase real-world DevOps practices. 
---
...
```bash
git clone https://github.com/Roblex-T/ci-cd-pipeline.git
...
- Set GitHub repo: `https://github.com/Roblex-T/ci-cd-pipeline.git`
- Branch: `*/main`
